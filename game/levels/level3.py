...
class Level3(Level):
    ...
    def build(self):
        ...
        tilemap.add(24,-3, 6, 1, S)   # step 8  (4-row gap from step 7)

        enemies = [
            # ground level — several patrolling guards
            Enemy(14, GROUND_ROW, 3, 3, 60),
            Enemy(22, GROUND_ROW, 3, 3, 60),
            Enemy(30, GROUND_ROW, 4, 4, 60),
            Enemy(40, GROUND_ROW, 4, 4, 60),
            # at least one per platform, climbing upward
            Enemy( 7,  7,  2, 6, 60),   # step 1
            Enemy( 5,  1,  1, 8, 60),   # step 3
            Enemy(22, -3,  0, 0, 80),   # step 4
            Enemy( 6, -6,  2, 7, 80),   # step 5
            Enemy(20, -10, 3, 4, 80),   # step 6
            Enemy( 6, -13, 2, 8, 80),   # step 7
            Enemy( 6, -13, 2, 8, 80),   # step 7
            Enemy(20, -17, 3, 3, 80),   # step 8
            Enemy(26, -3,  2, 3, 80),   # row -3 platform (cols 24-29)
        ]

        deliveries = [DeliveryTarget(18, -19, 2), DeliveryTarget(5, -7, 4), DeliveryTarget(27, 0, 3)]
