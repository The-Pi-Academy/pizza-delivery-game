...
class Level1(Level):
    ...
    def build(self) -> tuple[TileMap, list[Enemy], DeliveryTarget]:
        ...
        enemies.append(Enemy(5, GROUND_ROW, 0, 0, 60, True))
        ...
        enemies.append(Enemy(20, GROUND_ROW, 0, 0, 60, True))
        enemies.append(Enemy(25, GROUND_ROW, 21, 29))
        enemies.append(Enemy(30, GROUND_ROW, 21, 35))
        ...
        enemies.append(Enemy(40, 8, 0, 0, 60, True))
