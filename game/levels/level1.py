...
class Level1(Level):
    ...
    def build(self) -> tuple[TileMap, list[Enemy], DeliveryTarget]:
        ...
        enemies.append(Enemy(5, GROUND_ROW, 0, 0, 60))
        ...
        enemies.append(Enemy(20, GROUND_ROW, 0, 0, 60))
        enemies.append(Enemy(25, GROUND_ROW, 4, 4))
        enemies.append(Enemy(30, GROUND_ROW, 9, 5))
        ...
        enemies.append(Enemy(40, 8, 0, 0, 60))
